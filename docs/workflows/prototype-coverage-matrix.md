...
| --- | --- | --- | --- | --- | --- |
| Desktop Rail / Mobile Nav | Label HQ, Staff/Team, Missions, Manager, Profile/Settings | current route, workspace availability | route preference only | navigation shell | unavailable target |
...
| Checkpoints | select checkpoint | mission plan, checkpoints, tasks, evidence | checkpoint update/review if run | checkpoint/review service | missing evidence/conflict |
