...
Prompt output should separate user-facing prose from machine-readable actions.

## Agent Run Prompts

Inputs: artist profile, mission context if any, relevant sources, evidence items, source limitations, prior memory, trigger, pending Manager notes for this agent.  
...
Inputs: agent reports, agent notes, artist profile, memory, active missions, mission patterns, mission plans, tasks, checkpoints, notes, evidence, reviews, conversations, permissions.  
...
Inputs: user message, conversation history, active artist, active missions, mission patterns, tasks, checkpoints, notes, memory, evidence, agent reports, source limitations, agent readiness, permissions.  
...
Inputs: objective/risk/opportunity, trigger, active missions, available mission patterns, agent reports, evidence, memory, permissions.  
...
Inputs: decision request or proactive decision need, router/synthesis classification, evidence, profile, memory, active work, budget/source constraints, rejected alternatives.  
...
Inputs: artist profile, artist memory, active missions as supporting context, internal agent reports, tasks, checkpoints, reviews, operating events, evidence freshness, source limitations, permissions, recent reviews/conversations.  
...
- scope: artist, mission, conversation, task, checkpoint, source, or run
- confidence
